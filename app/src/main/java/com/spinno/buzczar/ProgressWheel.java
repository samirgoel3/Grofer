...
public class ProgressWheel extends View {
    private static final String TAG = com.pnikosis.materialishprogress.ProgressWheel.class.getSimpleName();
    ...
    public ProgressWheel(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs,
                com.pnikosis.materialishprogress.R.styleable.ProgressWheel));
    }
